...
import { addDeposit, AddDepositCredentials } from "../../../api/deposit/addDeposit";
...
const Clientdeposit = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const depositData: AddDepositCredentials = {
  ...
  return (
    <div className="container mt-4">
      <h2 className="fw-bold" style={{ color: 'var(--primary-color)',fontSize:'30px' }}>Client Deposit</h2>
      ...
      <div className="d-flex gap-3 mb-4">
        <Button
          ...
          onClick={() => {
            ...
            setSelectedClient(null);
            setClientSearchTerm("");
            setFormData({ mt5Id: "", amount: "", comment: "", clientName: ""});
          }}
        >
          Deposit With MT5 Id
        </Button>
          ...
          <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3">
              ...
              <Form.Select
                ...
                disabled={isLoadingMT5 || depositMutation.isPending}
              >
            ...
            <div className="row">
              ...
              <Form.Group className="mb-3 col-md-6 position-relative">
                ...
                <Form.Control
                  ...
                  disabled={isLoadingUsers || isLoadingMT5 || depositMutation.isPending}
                  style={inputStyle}
                  className={theme === "dark" ? "dark-mode-placeholder" : ""}
                />
              ...
              <Form.Group className="mb-3 col-md-6">
                ...
                <Form.Select
                  ...
                  style={inputStyle}
                  className={theme === "dark" ? "dark-mode-placeholder" : ""}
                  disabled={!selectedClient || isLoadingMT5 || depositMutation.isPending}
                >
                  <option value="">
                    {!selectedClient 
